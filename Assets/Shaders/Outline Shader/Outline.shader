//TODO
// CHANGE SHADER NAMES AND FOLDERS
// TO BLEND, USE _Color.a ON LINE 112
...
Shader "Hidden/Roystan/Outline Post Process"
{
	...
	uint stereoTargetEyeIndex : SV_RenderTargetArrayIndex;
            ...
            float4 Frag(Varyings i) : SV_Target
            {
	            ...
	            float2 bottomRightUV = i.texcoord + float2(_MainTex_TexelSize.x * halfScaleCeil,
	                                                       -_MainTex_TexelSize.y * halfScaleFloor);
	            float2 topLeftUV = i.texcoord + float2(-_MainTex_TexelSize.x * halfScaleFloor,
